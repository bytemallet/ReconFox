from reconfox.tool.retriever_modules import domains,subdomains,urls,files,emails,people,dorks
from reconfox.tool.analysis_modules import domain_analysis,email_analysis,files_analysis,usernames_analysis,people_analisys
...
@shared_task(bind=True, name="get_email_pattern")
def getEmailPatternTask(self, domain):
	email_analysis.getEmailPattern(domain)
