...
from reconfox.models import Emails,Subdomains
...
def canBeSpoofed(domain_id):
	...
	for entry in queryset:
		...
		if res and ("NOT" not in res or "CAN" not in res):
...
def subdomainTakeOverAnalysis(domain_id):
	...
	for entry in queryset.iterator():
		...
		result = False
		fingerprints = json.load(open("reconfox/tool/analysis_modules/fingerprints.json"))
